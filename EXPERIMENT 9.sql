...
SELECT itemid FROM Orders_Exp9_Csea_16 UNION SELECT itemid FROM Orders_Exp9_Csea_16 WHERE itemid NOT IN (SELECT itemid FROM Delivery_Exp9_Csea_16 d JOIN orders_exp9_csea_16 o ON d.orderid=o.orderid);
